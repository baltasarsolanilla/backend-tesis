(function() {
  ...
  module.directive('abnTree', [
    '$timeout', function($timeout) {
      return {
        restrict: 'E',
        templateUrl: 'js/angular/tablero-page/estrategia-tree/abn-tree/abn-tree.html',
        replace: true,
        scope: {
          treeData: '=',
          onSelect: '&',
        ...
        link: function(scope, element, attrs) {
          ...
          if (scope.treeControl != null) {
            if (angular.isObject(scope.treeControl)) {
              ...
              /*
              *Added level control, starting by 1.
              */
              tree.add_branch = function(parent, new_branch) {
                if (parent != null) {
                  new_branch.level = parent.level + 1; //added to have level control
                  parent.children.push(new_branch);
                  parent.expanded = true;
                } else {
                  new_branch.level = 1; //added to have level control
